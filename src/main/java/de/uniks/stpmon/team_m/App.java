...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        if (authenticationService.isRememberMe()) {
            ...
            disposables.add(authenticationService.refresh().observeOn(Schedulers.from(Platform::runLater)).subscribe(lr -> show(component.mainMenuController()), err -> show(component.loginController())));
        } else {
